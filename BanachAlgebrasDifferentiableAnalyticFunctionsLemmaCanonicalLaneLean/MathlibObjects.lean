import BanachAlgebrasDifferentiableAnalyticFunctionsLemmaCanonicalLaneLean.TheoremStatement
...
abbrev BanachAlgebra (𝕜 : Type u) [NontriviallyNormedField 𝕜] (A : Type v) [NonUnitalNormedRing A] [NormedSpace 𝕜 A] : Type v :=
  A
